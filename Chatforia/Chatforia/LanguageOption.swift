...
enum AppLanguages {
    static let all: [LanguageOption] = [
        ...
        .init(code: "gom", name: "Konkani"),
        .init(code: "ko", name: "Korean"),
        .init(code: "kri", name: "Krio"),
        .init(code: "kmr", name: "Kurdish (Kurmanji)"),
        ...
        .init(code: "nb", name: "Norwegian Bokmål"),
